...
#
# This is lab-agnostic. It installs ESP-IDF, sets up USB access, and
# configures the shell. Run once per machine, then run setup-labs.sh
# to provision individual labs.
#
# Usage:
...
ESP_IDF_BRANCH="v5.3.2"            # pin to a known-good release
...
# udev rule: make Espressif USB devices (VID 303a) world-accessible.
# Covers both the ROM bootloader and running firmware.
...
# Serial/USB groups for /dev/ttyACM* access
...
# Source ESP-IDF to check version
